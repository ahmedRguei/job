...
class CandidateTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getLatittudeReturnsInitialValueForString()
    {
        self::assertSame(
            '',
            $this->subject->getLatittude()
        );
     ...
     * @test
     */
    public function setLatittudeForStringSetsLatittude()
    {
        $this->subject->setLatittude('Conceived at T3CON10');
