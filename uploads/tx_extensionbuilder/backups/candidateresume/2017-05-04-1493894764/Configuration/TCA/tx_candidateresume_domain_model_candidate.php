...
return [
    'ctrl' => [
		...
		'searchFields' => 'first_name,last_name,address,city,phone,email,experiences,educations,skills,languages',
        'iconfile' => 'EXT:candidateresume/Resources/Public/Icons/tx_candidateresume_domain_model_candidate.gif'
    ],
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, first_name, last_name, address, city, phone, email, experiences, educations, skills, languages',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, first_name, last_name, address, city, phone, email, experiences, educations, skills, languages, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
