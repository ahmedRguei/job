...
return [
    ...
    'columns' => [
	    ...
	    'professional_title' => [
	        'exclude' => false,
	        'label' => 'LLL:EXT:candidateresume/Resources/Private/Language/locallang_db.xlf:tx_candidateresume_domain_model_candidate.professional_title',
	        'config' => [
			    'type' => 'input',
			    'size' => 30,
			    'eval' => 'trim'
	    ...
	    'linkedin' => [
	        'exclude' => false,
	        'label' => 'LLL:EXT:candidateresume/Resources/Private/Language/locallang_db.xlf:tx_candidateresume_domain_model_candidate.linkedin',
	        'config' => [
			    'type' => 'input',
			    'size' => 30,
			    'eval' => 'trim'
	    ...
	    'availability' => [
	        'exclude' => 1,
	        'label' => 'LLL:EXT:candidateresume/Resources/Private/Language/locallang_db.xlf:tx_candidateresume_domain_model_candidate.availability',
            'config' => [
                'type' => 'radio',
                'items' => [
                    [
                        'LLL:EXT:candidateresume/Resources/Private/Language/locallang_db.xlf:tx_candidateresume_domain_model_candidate.availability.I.0', 'yes'
                    ],
                    [
                        'LLL:EXT:candidateresume/Resources/Private/Language/locallang_db.xlf:tx_candidateresume_domain_model_candidate.availability.I.1', 'no'
                    ]
                ]
            ],
	    ],
	    'planned_interview_date' => [
	        'exclude' => false,
	    ...
	    'interview_notes' => [
	        'exclude' => false,
	        'label' => 'LLL:EXT:candidateresume/Resources/Private/Language/locallang_db.xlf:tx_candidateresume_domain_model_candidate.interview_notes',
	        'config' => [
			    'type' => 'input',
			    'size' => 50,
			    'eval' => 'trim'
	    ...
	    'resmue' => [
	        'exclude' => false,
	        'label' => 'LLL:EXT:candidateresume/Resources/Private/Language/locallang_db.xlf:tx_candidateresume_domain_model_candidate.resmue',
	        'config' => [
			    'type' => 'input',
			    'size' => 50,
			    'eval' => 'trim,required'
        ...
        'spoken_language' => [
            'exclude' => false,
            'label' => 'LLL:EXT:candidateresume/Resources/Private/Language/locallang_db.xlf:tx_candidateresume_domain_model_candidate.spoken_language',
            'config' => [
                'type' => 'input',
                'size' => 100,
                'eval' => 'trim'
        ...
        'acquired_skills' => [
            'exclude' => false,
            'label' => 'LLL:EXT:candidateresume/Resources/Private/Language/locallang_db.xlf:tx_candidateresume_domain_model_candidate.acquired_skills',
            'config' => [
                'type' => 'input',
                'size' => 100,
                'eval' => 'trim'
